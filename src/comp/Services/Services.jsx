...
export default function Services() {
  return <>
      ...
      <div className='my-7'><h2 className='text-center font-bold text-[30px]  md:text-[60px] text-white nunito '> Our Services & Features</h2></div>
      <div className='grid  grid-cols-1 place-items-center p-5 md:p-28   gap-5      md:grid-cols-2   md:px-14 lg:grid-cols-3 lg:px-32 mb-32  border-purple-800 shadow-[inset_0_0_25px_5px_rgba(128,0,128,0.6)]    '>
