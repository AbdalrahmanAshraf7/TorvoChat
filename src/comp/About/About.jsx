  ...
  <div className='flex flex-col md:flex-row mt-14   '>
    <div className='flex flex-col gap-2 p-3  md:w-[80%]   '>
        <span className='flex flex-col gap-1 p-3 lg:px-52'>
         <p className='font-bold text-purple-400 text-xl nunito'>
            Our message 
         </p>
         <p className='font-medium text-[19px] md:text-[15px] text-white '>
...
<div className="flex  md:w-[400px] w-[250px] h-[400px] nunito  back-ground-header  justify-center items-center rounded-tl-[200px] rounded-bl-[250px] rounded-tr-[50px] rounded-br-[50px] mb-5">
    ...
    <div className=' w-full  grid grid-cols-1 lg:grid-cols-2 md:grid-cols-1 gap-7 md:order-1'>
        <div>
            <div className='flex flex-col gap-1'>
                <span className='flex items-center gap-5'>
                 <i class="fa-solid fa-shield-halved text-2xl text-purple-400"></i> <span className='font-bold'>Privacy First</span> 
            </span>
            <span className='ms-13 text-gray-300'>
        ...
        <div>
            <div className='flex flex-col gap-1'>
                <span className='flex items-center gap-5'>
                <i class="fa-solid fa-tower-broadcast text-2xl text-purple-400"></i> <span className='font-bold'>Ease of communication</span> 
            </span>
            <span className='ms-13 text-gray-300'>
        ...
        <div>
            <div className='flex flex-col gap-1'>
                <span className='flex items-center gap-5'>
                 <i class="fa-solid fa-user-group text-2xl text-purple-400"></i> <span className='font-bold'>One team </span>
            </span>
            <span className='ms-13 text-gray-300'>
        ...
        <div>
            <div className='flex flex-col gap-1'>
                <span className='flex items-center gap-5'>
                <i class="fa-solid fa-circle-check text-2xl text-purple-400"></i> <span className='font-bold'> More success </span>
            </span>
              <span className='ms-13 text-gray-300'>
        ...
        <div>
            <div className='flex flex-col gap-1'>
                <span className='flex items-center gap-5'>
                 <i class="fa-solid fa-thumbs-up text-2xl text-purple-400"></i> <span className='font-bold'>Always with you </span>
            </span>
              <span className='ms-13 text-gray-300'>
        ...
        <div>
            <div className='flex flex-col gap-1'>
                <span className='flex items-center gap-5'>
                <i class="fa-solid fa-hand-holding-heart text-2xl text-purple-400"></i> <span className='font-bold'>Your opinion matters to us </span>
            </span>
              <span className='ms-13 text-gray-300'>
