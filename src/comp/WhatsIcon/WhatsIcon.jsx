...
import whatsUser from "../../assets/icona.png"
...
export default function WhatsIcon() {
  ...
  <div className={`p-5    fixed bottom-20 left-12 z-[9999999] ${toggleWhats === false ? "hidden" : ""}`}>
            <div className='bg-purple-900 py-2 rounded-tl-lg rounded-tr-lg flex justify-between items-center px-2'>
              <div>
            ...
            <img className='w-[300px]  h-[310px] rounded-bl-lg rounded-br-lg border-1 border-purple-500' src={WhatsBack} alt="" />
            <div className='flex absolute top-24 left-[40px] gap-0.5 '>
              <div className=' bg-[#4fbf73] border-1 border-purple-500 h-[40px] w-[40px] rounded-full flex items-center justify-center overflow-hidden '>
...
<a
  href={`https://api.whatsapp.com/send?phone=201505753059&text=${encodeURIComponent(inputWhats.trim() || "Details, please")}`}
  target="_blank"
